...
interface Props  {
  match: ESportsMatch,
  getWinnerName: (winnerId: number | null, opponents: ESportsOpponent[]) => string | undefined;
  getWinnerLogo: (winnerId: number | null, opponents: ESportsOpponent[]) => string | undefined;
};
        ...
        match.games.map((game, i) => {
          ...
          return (game.finished) ? (
            <div key={i} className="game-row">
              ...
              <div>Winner:</div>
              <div>
                <img className="team-logo-small" src={getWinnerLogo(winnerId, match.opponents)} />
