...
interface StateProps { csgo: CsgoState; };
interface DispatchProps { getCsgoTournaments; getCsgoTournamentMatches; };
...
class CsgoTournamentContainer extends React.Component<Props, State> {
  ...
  handleTournamentChange = tournamentId => {
    const { csgo } = this.props;
    if (!csgo.tournamentMatches.length || csgo.tournamentMatches[0].tournament.id != tournamentId)
      ...
      <div className="section">
        <div className="select-dd">
          <SingleTournamentSelectDropdown handleChange={this.handleTournamentChange}
            ...
            value={this.getTournamentId(this.props.csgo.tournamentMatches, this.state.tournamentId)} />
        </div>
        ...
        <div>
          <CsgoTournamentMatches matches={this.getMatchesForTable(
...
export default connect(mapStateToProps, mapDispatchToProps)(CsgoTournamentContainer);
