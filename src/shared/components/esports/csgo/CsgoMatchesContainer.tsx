...
import { getCsgoMatches, getCsgoTournaments } from '../../../redux/csgo/csgo-actions';
...
interface DispatchProps {
  getCsgoMatches; getCsgoTournaments;
}
  ...
  render() {
    return (
      <div className="section">
        ...
        <div>
          <CsgoTournamentMatches header="Matches"
...
export default connect(mapStateToProps, mapDispatchToProps)(CsgoMatchesContainer);
