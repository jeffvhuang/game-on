...
class DotaSeriesTournamentsContainer extends React.Component {
  constructor(props) {
    super(props);
    ...
    return (
      <div className="page-main-section">
        ...
        <div className="section-left">
          {/* <DotaSeriesTournaments header="Tournaments"
...
DotaSeriesTournamentsContainer.propTypes = propTypes;
export default DotaSeriesTournamentsContainer;
