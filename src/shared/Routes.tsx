  ...
  render() {
    return (
      <Switch>
        ...
        <Route path={paths.SPORTS + '/basketball/matches/:matchId'} component={BasketballMatchPage} />
        <Route path={paths.SPORTS + '/basketball'} component={BasketballPage} />
        <Route path={paths.SPORTS + '/football'} component={FootballPage} />
        <Route path={paths.SPORTS + '/tennis/:tournamentNumber'} component={TennisTournamentPage} />
