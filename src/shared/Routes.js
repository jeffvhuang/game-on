...
import DotaTournamentPageContainer from './components/esports/DotaTournamentPageContainer';
  ...
  render() {
    return (
      <Switch>
        ...
        <Route path={paths.ESPORTS + '/dota/:tournamentNumber'} component={DotaTournamentPageContainer} />
